...
(14, 'mauludianto08@gmail.com', '12345', 'Abel ', 'jl pinang kota depok', '24421232141'),
(15, 'faruk01@gmail.com', '12345', 'Faruk', 'jl apel', '123456'),
(16, 'dandy02@gmail.com', '12345', 'dandy', 'jl kapung sawah', '133141241525'),
(17, 'putri@gmail.com', '12345', 'putri', 'jl tohir', '42525252626');
...
(58, 95, 'abel', 'BCA', 2509000, '2024-05-01', '20240501174740download (1).jpg'),
(59, 97, 'abel', 'BCA', 17018000, '2024-05-01', '20240501181111download (2).jpg'),
(60, 98, 'nabila', 'BCA', 45036000, '2024-05-03', '20240503151035download (1).jpg'),
(61, 96, 'Al', 'Mandiri', 2000, '2024-05-03', '20240503151751');
...
(1, 14, '2024-05-01', 2509000, 'Jl Pinang Kota Depok', 'Barang Dikirim', '', 0, 'Jawa Barat', 'Depok', 'Kota', '16416', 'jne', 'OKE', 9000, '2-3'),
(2, 14, '2024-05-01', 5409000, 'jl pinang', 'sudah kirim pembayaran', '', 0, 'Jawa Barat', 'Depok', 'Kota', '16416', 'jne', 'OKE', 9000, '2-3'),
(3, 14, '2024-05-01', 17018000, 'jl kapuk kota depok', 'Barang Dikirim', 'p094294251514', 0, 'Jawa Barat', 'Depok', 'Kota', '16416', 'jne', 'YES', 18000, '1-1'),
(4, 14, '2024-05-03', 45036000, 'JL Kebanggaan Keluarga', 'sudah kirim pembayaran', '', 0, 'Jawa Barat', 'Bogor', 'Kabupaten', '16911', 'jne', 'YES', 36000, '1-1'),
(99, 14, '2024-05-03', 15518000, 'Jalanin dulu aja', 'Belum Dibayar', '', 0, 'Jawa Barat', 'Depok', 'Kota', '16416', 'jne', 'YES', 18000, '1-1'),
(100, 14, '2024-05-03', 15018000, 'jalan jalan ', 'Belum Dibayar', '', 0, 'Jawa Barat', 'Depok', 'Kota', '16416', 'jne', 'YES', 18000, '1-1'),
(101, 15, '2024-05-03', 24360000, 'Jl Pinang', 'Belum Dibayar', '', 0, 'Jawa Barat', 'Depok', 'Kota', '16416', 'jne', 'YES', 360000, '1-1');
...
(129, 95, 0, 1, 'harddisk', 2500000, 500, 500, 2500000),
(130, 96, 4, 1, 'monitor', 5000000, 400, 400, 5000000),
(131, 96, 5, 1, 'ram vgen', 400000, 100, 100, 400000),
(132, 97, 7, 1, 'intel core i9', 12000000, 50, 50, 12000000),
(133, 97, 4, 1, 'monitor', 5000000, 400, 400, 5000000),
(134, 98, 4, 1, 'monitor', 5000000, 400, 400, 5000000),
(135, 98, 6, 5, 'hp samsung', 8000000, 200, 1000, 40000000),
(136, 99, 8, 1, 'speaker jbl', 500000, 100, 100, 500000),
(137, 99, 3, 1, 'cpu', 15000000, 300, 300, 15000000),
(138, 100, 3, 1, 'cpu', 15000000, 300, 300, 15000000),
(139, 101, 2, 2, 'laptop', 12000000, 10000, 20000, 24000000);
...
(0, 1, 'harddisk', 2500000, 500, '24.jpg', 'Lorem, ipsum dolor sit amet consectetur adipisicing elit. Placeat et ipsam esse blanditiis laboriosam fugit minus distinctio animi, totam beatae mollitia magnam ea sapiente nesciunt nobis facilis nihil aliquam sed.', 16),
(2, 1, 'laptop', 12000000, 10000, '16.jpg', 'Lorem, ipsum dolor sit amet consectetur adipisicing elit. Placeat et ipsam esse blanditiis laboriosam fugit minus distinctio animi, totam beatae mollitia magnam ea sapiente nesciunt nobis facilis nihil aliquam sed.', 29),
(3, 1, 'cpu', 15000000, 300, '6.png', 'Lorem, ipsum dolor sit amet consectetur adipisicing elit. Placeat et ipsam esse blanditiis laboriosam fugit minus distinctio animi, totam beatae mollitia magnam ea sapiente nesciunt nobis facilis nihil aliquam sed.', 40),
(4, 1, 'monitor', 5000000, 400, '8.png', 'Lorem, ipsum dolor sit amet consectetur adipisicing elit. Placeat et ipsam esse blanditiis laboriosam fugit minus distinctio animi, totam beatae mollitia magnam ea sapiente nesciunt nobis facilis nihil aliquam sed.', 39),
(5, 1, 'ram vgen', 400000, 100, '7.png', 'Lorem, ipsum dolor sit amet consectetur adipisicing elit. Placeat et ipsam esse blanditiis laboriosam fugit minus distinctio animi, totam beatae mollitia magnam ea sapiente nesciunt nobis facilis nihil aliquam sed.', 46),
(6, 2, 'hp samsung', 8000000, 200, '17.jpg', 'Lorem, ipsum dolor sit amet consectetur adipisicing elit. Placeat et ipsam esse blanditiis laboriosam fugit minus distinctio animi, totam beatae mollitia magnam ea sapiente nesciunt nobis facilis nihil aliquam sed.', 38),
(7, 1, 'intel core i9', 12000000, 50, '15.jpg', 'Lorem, ipsum dolor sit amet consectetur adipisicing elit. Placeat et ipsam esse blanditiis laboriosam fugit minus distinctio animi, totam beatae mollitia magnam ea sapiente nesciunt nobis facilis nihil aliquam sed.', 46),
(8, 1, 'speaker jbl', 500000, 100, '21.jpg', 'Lorem, ipsum dolor sit amet consectetur adipisicing elit. Placeat et ipsam esse blanditiis laboriosam fugit minus distinctio animi, totam beatae mollitia magnam ea sapiente nesciunt nobis facilis nihil aliquam sed.', 44),
(34, 0, 'Kacamata Tipis', 150000, 1, 'download (2).jpg', 'Ini kacamata', 15);
...
--
ALTER TABLE `pembayaran`
  MODIFY `id_pemabayaran` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;

--
-- AUTO_INCREMENT untuk tabel `pembelian`
--
ALTER TABLE `pembelian`
  MODIFY `id_pembelian` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102;

--
-- AUTO_INCREMENT untuk tabel `pembelian_produk`
--
ALTER TABLE `pembelian_produk`
  MODIFY `id_pembelian_produk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=140;
