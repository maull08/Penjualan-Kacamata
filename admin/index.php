...
<head>
  ...
  <title>Admin : Optik Empat Mata</title>
  <!-- BOOTSTRAP STYLES-->
        ...
        <nav class="navbar navbar-default navbar-cls-top" style="margin-bottom: 0">
            ...
            <?php while($pecah=$ambil->fetch_assoc()){ ?>
                <span class="navbar-text" style="color: white; width: 1000px;font-size: 16px;">
                    <marquee behavior="scroll" direction="right">Selamat datang Admin</marquee>
                </span>
...
<li>
                          <a href="index.php?halaman=produk"><i class="fa fa-tablet"></i>  Data Produk</a>                        </li>
<li><a href="index.php?halaman=pembelian"><i class="fa fa-shopping-cart"></i>Data Pembelian</a></li>
<li><a href="index.php?halaman=laporan_pembelian"><i class="fa fa-file"></i> Laporan Penjualan</a></li>
