...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 13 Bulan Mei 2024 pada 07.08
...
(18, 'maul02@gmail.com', '12345', 'maul', 'jl karet', '02449124252353'),
(19, 'dadang1@gmail.com', '12345', 'dadang', 'jl kapuy', '12345646464');
...
(62, 102, 'maul', 'BCA', 418000, '2024-05-05', '20240505162156download (1).jpg'),
(63, 103, 'maul', 'mandiri', 15018000, '2024-05-06', '20240506081639download.jpg'),
(64, 103, 'maul', 'cimb niaga', 15018000, '2024-05-06', '20240506082049download.jpg'),
(65, 104, 'ableh', 'BCA', 40058000, '2024-05-10', '20240510200849download.png'),
(66, 109, 'maul', 'BCA', 118000, '2024-05-11', '20240511074223download.jpg');
...
(102, 18, '2024-05-05', 418000, 'jl karet', 'Belum Dibayar', '', 0, 'Jawa Barat', 'Bogor', 'Kota', '16119', 'jne', 'YES', 18000, '1-1'),
(103, 18, '2024-05-06', 15018000, 'jl manggis', 'Sudah Kirim Pembayaran', '', 0, 'Jawa Barat', 'Bogor', 'Kota', '16119', 'jne', 'YES', 18000, '1-1'),
(104, 18, '2024-05-10', 40058000, 'jl kapu', 'Lunas', '', 0, 'Jambi', 'Jambi', 'Kota', '36111', 'jne', 'YES', 58000, '1-1'),
(105, 18, '2024-05-10', 7018000, 'jl', 'Belum Dibayar', '', 0, 'Jawa Barat', 'Bogor', 'Kota', '16119', 'jne', 'YES', 18000, '1-1'),
(106, 19, '2024-05-10', 7010000, 'jl kapuy', 'Belum Dibayar', '', 0, 'DKI Jakarta', 'Jakarta Barat', 'Kota', '11220', 'jne', 'CTC', 10000, '1-2'),
(107, 19, '2024-05-10', 12018000, 'jl', 'Belum Dibayar', '', 0, 'DKI Jakarta', 'Jakarta Barat', 'Kota', '11220', 'jne', 'CTCYES', 18000, '1-1'),
(108, 18, '2024-05-11', 12018000, 'jl', 'Belum Dibayar', '', 0, 'DKI Jakarta', 'Jakarta Barat', 'Kota', '11220', 'jne', 'CTCYES', 18000, '1-1'),
(109, 18, '2024-05-11', 118000, 'hj ', 'Lunas', '', 0, 'Jawa Barat', 'Depok', 'Kota', '16416', 'jne', 'YES', 18000, '1-1');
...
(140, 102, 5, 1, 'ram vgen', 400000, 100, 100, 400000),
(141, 103, 3, 1, 'cpu', 15000000, 300, 300, 15000000),
(142, 104, 50, 1, 'Ableh', 40000000, 1, 1, 40000000),
(143, 105, 54, 1, 'po', 7000000, 1, 1, 7000000),
(144, 106, 54, 1, 'po', 7000000, 1, 1, 7000000),
(145, 107, 7, 1, 'intel core i9', 12000000, 50, 50, 12000000),
(146, 108, 7, 1, 'intel core i9', 12000000, 50, 50, 12000000),
(147, 109, 35, 1, 'Gues', 100000, 10, 10, 100000);
...
(35, 0, 'Gues', 100000, 10, 'guess.png', '', 9),
(56, 0, 'Hang Ten', 155000, 15, 'Frame Hang Ten.png', '', 20),
(57, 0, 'Carrera', 200000, 15, 'parera.jpg', '', 25),
(58, 0, 'Serenade', 220000, 3, 'serenade.png', '', 15),
(59, 0, 'Giordano', 250000, 3, 'gior.png', '', 30),
(68, 0, 'Nike', 270000, 2, 'Nike.jpg', '', 15),
(69, 0, 'Converse', 300000, 3, 'converse.png', '', 30),
(70, 0, 'Illustro Prestige', 550000, 3, 'YY.png', '', 30);
...
--
ALTER TABLE `pembayaran`
  MODIFY `id_pemabayaran` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;

--
-- AUTO_INCREMENT untuk tabel `pembelian`
--
ALTER TABLE `pembelian`
  MODIFY `id_pembelian` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=110;

--
-- AUTO_INCREMENT untuk tabel `pembelian_produk`
--
ALTER TABLE `pembelian_produk`
  MODIFY `id_pembelian_produk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=148;
